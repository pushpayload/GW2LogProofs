...
std::vector<BossGroup> WingmanBossProvider::GetBossGroups() const {
	return {
			...
			{"Fractal CMs", "cmFractalsTable",    BossCategory::FRACTAL_CM,    {{MAMACM, BossType::CM}, {SiaxTheCorruptedCM, BossType::CM}, {EnsolyssOfTheEndlessTormentCM, BossType::CM}, {SkorvaldTheShatteredCM, BossType::CM}, {ArtsariivCM, BossType::CM}, {ArkkCM, BossType::CM}, {ElementalAiKeeperOfThePeakCM, BossType::CM}, {DarkAiKeeperOfThePeakCM, BossType::CM}, {ElementalAndDarkAiKeeperOfThePeakCM, BossType::CM}, {KanaxaiScytheOfHouseAurkusCM, BossType::CM}, {EparchCM, BossType::CM}, {KinfallCM, BossType::CM}}                                                                                                                                                                                                                                                                                                                                                                                                                                                                    },
			{"Strikes",     "normalStrikesTable", BossCategory::STRIKE_NORMAL, {{IcebroodConstruct, BossType::NORMAL}, {TheVoiceAndTheClaw, BossType::NORMAL}, {FraenirOfJormag, BossType::NORMAL}, {Boneskinner, BossType::NORMAL}, {WhisperOfJormag, BossType::NORMAL}, {Freezie, BossType::NORMAL}, {CaptainMaiTrin, BossType::NORMAL}, {Ankka, BossType::NORMAL}, {MinisterLi, BossType::NORMAL}, {VoidAmalgamate, BossType::NORMAL}, {OldLionsCourt, BossType::NORMAL}, {Dagda, BossType::NORMAL}, {Cerus, BossType::NORMAL}, {Kela, BossType::NORMAL}}                                                                                                                                                                                                                                                                                                                                                                                                                                              },
			{"Strike CMs",  "cmStrikesTable",     BossCategory::STRIKE_CM,     {{CaptainMaiTrinCM, BossType::CM}, {AnkkaCM, BossType::CM}, {MinisterLiCM, BossType::CM}, {VoidAmalgamateCM, BossType::CM}, {OldLionsCourtCM, BossType::CM}, {DagdaCM, BossType::CM}, {CerusCM, BossType::CM}, {KelaCM, BossType::CM}}																																																																																																																																																																					 },
...
std::vector<ProofOption> WingmanBossProvider::GetAvailableProofs() const {
	...
	static const std::vector<Boss> strikeNormal = {IcebroodConstruct, TheVoiceAndTheClaw, FraenirOfJormag, Boneskinner, WhisperOfJormag, Freezie, CaptainMaiTrin, Ankka, MinisterLi, VoidAmalgamate, OldLionsCourt, Dagda, Cerus, Kela};
	static const std::vector<Boss> strikeCM = {CaptainMaiTrinCM, AnkkaCM, MinisterLiCM, VoidAmalgamateCM, OldLionsCourtCM, DagdaCM, CerusCM, KelaCM};
