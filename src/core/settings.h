...
extern const char* WEIGH_WINGMAN_MECHANICS_TEAMPLAY_LESS;
extern const char* USE_WINGMAN_REV_PROFILE;
...
namespace Settings {
	...
	extern bool WeighWingmanMechanicsTeamplayLess;
	extern bool UseWingmanRevProfile;
